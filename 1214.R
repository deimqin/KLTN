...
# ==============================================================
# PHẦN 1: TARGET - Lấy total_food_con từ năm 2014
# ==============================================================
...
# ==============================================================
# PHẦN 2: FEATURES - Lấy tất cả biến từ năm 2012
# ==============================================================
...
# ==============================================================
# PHẦN 3: MERGE - Kết hợp Target 2014 với Features 2012
# ==============================================================
food_consumption_1214 <- target_2014 %>% 
...
food_consumption_1214 <- food_consumption_1214 %>%
  rename(
    # Target
    target_food_2014 = total_food_con_2014,
  ...
  relocate(target_food_2014, .after = last_col())

# Xuất file
write.csv(food_consumption_1214, "C:/Users/My PC/food_prediction_2014_from_2012.csv", row.names = FALSE)
