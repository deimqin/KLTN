...
# 1: TARGET - Lấy total_food_con từ năm 2016
actual_food_16 <- data_food_consumption %>% 
...
# 3: MERGE - Kết hợp Target 2016 với Features 2014
food_consumption_1416 <- actual_food_16 %>% 
...
food_consumption_1416 <- food_consumption_1416 %>%
  rename(
    # Target
    actual_food_16 = total_food_con_2016,
  ...
  relocate(actual_food_16, .after = last_col())

# Xuất file
write.csv(food_consumption_1416, "C:/Users/My PC/Videos/KLTN/food_consumption_1416.csv", row.names = FALSE)
