...
# ==============================================================
# PHẦN 1: TARGET - Lấy total_food_con từ năm 2016
# ==============================================================
target_2016 <- data_food_consumption %>% 
  filter(h_code %in% full_16_14_12, year == 2016) %>%
  select(h_code, total_food_con_2016 = total_food_con)

# ==============================================================
# PHẦN 2: FEATURES - Lấy tất cả biến từ năm 2014
# ==============================================================
...
# ==============================================================
# PHẦN 3: MERGE - Kết hợp Target 2016 với Features 2014
# ==============================================================
food_consumption_1416 <- target_2016 %>% 
...
food_consumption_1416 <- food_consumption_1416 %>%
  rename(
    # Target
    target_food_2016 = total_food_con_2016,
  ...
  relocate(target_food_2016, .after = last_col())

# Xuất file
write.csv(food_consumption_1416, "C:/Users/My PC/food_prediction_2016_from_2014.csv", row.names = FALSE)
